  ...
  const handleEmployeeRegister = async (data) => {
    ...
    registerUser(data.email, data.password)
      .then(async () => {
        ...
        await axios.post(image_API_URL, formData).then(async (res) => {
          ...
          await axiosInstance.post("/users/employee", userInfo).then((res) => {
      ...
      .catch(() =>
        toast.error("Error! Could't register your account, try again please!")
      );
  };
      ...
      <div className="card bg-base-100 w-full max-w-md shadow-xl p-6">
        ...
        <form onSubmit={handleSubmit(handleEmployeeRegister)} className="">
          ...
          <input
            type="file"
            {...register("photo")}
            className="w-full file-input mb-2"
