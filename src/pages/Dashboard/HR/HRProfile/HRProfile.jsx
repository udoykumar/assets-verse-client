    ...
    <div className="w-full max-w-3xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <img
            src={
              ...
              profile.photoURL ||
              profile.companyLogo ||
              "https://i.ibb.co/y0K6vBp/user.png"
            }
            alt="Profile"
        ...
        <div className="bg-base-200 p-4 rounded-lg">
          <h3 className="font-semibold text-2xl label mb-4">
            Account Details:
          </h3>
          ...
          <p>
            <strong>Package Limit:</strong> {profile.packageLimit}
          </p>
          <p>
        ...
        {/* SUBMIT BTN */}
        <button className="btn btn-accent hover:btn-info w-full">
          Update Profile
        </button>
      </form>
    </div>
